    ...
    <div>
      <div className="background-image ">
        <div className="input-table backdrop-blur-[10px] flex flex-col items-center box-border min-h-screen pt-6 sm:justify-center sm:pt-0  ">
          <div className="mb-20 ">
            <a className="flex flex-col items-end hover:no-underline"  href="./trangchu">
              <h3 className="hodaText leading-[75px] text-9xl font-mono tracking-tighter  text-white">HoDa</h3>
              <h4 className="bookingText text-3xl font-mono tracking-tighter text-white">Booking</h4>
            </a>
          </div>
